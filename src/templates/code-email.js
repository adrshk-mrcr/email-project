...
function renderDesktop(code) {
  return `
    <div style="position:relative; width:532px; background-color:#ffffff; border-radius:24px; overflow:hidden;">
      <img src="${ASSETS.decor}" alt="" width="360" height="360" style="display:block; position:absolute; top:-96px; right:-95px; width:360px; height:360px;" />
      <table role="presentation" width="532" cellpadding="0" cellspacing="0" border="0" class="email-root email-card" style="position:relative; z-index:1;">
        <tr>
